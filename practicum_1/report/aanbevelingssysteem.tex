...
\noindent Voor gebruiker 10100 worden voornamelijk Marvel films aangeraden en dat komt wel degelijk overeen met  de testmatrix. Voor gebruiker 98 komen 3 aanbevelingen overeen met diens hoogst-beoordeelde films (in matrix $T$, niet in matrix $R$). De andere films hebben een gelijkaardig genre, dus is wat aangeraden wordt best ok\'e.\\
